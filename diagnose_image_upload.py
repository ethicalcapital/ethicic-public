...
def diagnose_image_upload():
    ...
    if not settings.DEBUG:
        security_settings = [
            ...
            ('SECURE_CONTENT_TYPE_NOSNIFF', getattr(settings, 'SECURE_CONTENT_TYPE_NOSNIFF', 'Not set')),
    ...
    print(f"\n⚙️  WAGTAIL SETTINGS:")
    wagtail_settings = [
        ('WAGTAILIMAGES_MAX_UPLOAD_SIZE', getattr(settings, 'WAGTAILIMAGES_MAX_UPLOAD_SIZE', 'Not set')),
        ('WAGTAILIMAGES_EXTENSIONS', getattr(settings, 'WAGTAILIMAGES_EXTENSIONS', 'Not set')),
        ('WAGTAILADMIN_BASE_URL', getattr(settings, 'WAGTAILADMIN_BASE_URL', 'Not set')),
    ]
