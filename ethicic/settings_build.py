...
SECRET_KEY = 'build-phase-temporary-key-not-for-production'
...
# Application definition - minimal for collectstatic
INSTALLED_APPS = [
...
# Database - SQLite for build only
DATABASES = {
    'default': {
...
# Don't send emails during build
