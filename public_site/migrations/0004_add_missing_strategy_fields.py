...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='strategypage',
            name='benchmark_name',
            field=models.CharField(blank=True, default='ACWI', help_text='e.g., ACWI, AGG/PFF, S&P 500', max_length=50),
        ),
        migrations.AddField(
            model_name='strategypage',
            name='ytd_benchmark',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, default='Higher conviction in these sectors', max_length=300),
        ),
        migrations.AddField(
            model_name='strategypage',
            name='exclusions_note',
            field=models.CharField(blank=True, default='22% of benchmark index excluded', max_length=300),
        ),
        migrations.AddField(
            model_name='strategypage',
            name='healthcare_exclusion_note',
            field=models.TextField(blank=True, default='* Healthcare exclusions are selective, focused on companies that directly support abortion procedures or controversial research practices'),
        ),
        migrations.AddField(
            model_name='strategypage',
            name='performance_disclaimer',
            field=wagtail.fields.RichTextField(blank=True, help_text='Performance disclaimer text'),
        ),
    ]