    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "allocation_percent",
                    models.CharField(max_length=20, help_text="e.g., 73.1%"),
                ),
                (
                    "benchmark_percent",
                    models.CharField(
                        blank=True, max_length=20, help_text="e.g., 62.3%"
                    ),
                ),
                (
                    "difference_percent",
                    models.CharField(
                        blank=True, max_length=20, help_text="e.g., +10.8%"
                    ),
                ),
                (
                    "page",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "weight_percent",
                    models.CharField(max_length=20, help_text="e.g., 3.5%"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_url",
                    models.URLField(
                        blank=True, help_text="External URL for the document"
                    ),
                ),
                (
                    "icon",
                    models.CharField(
                        default="📄",
                        max_length=10,
                        help_text="Emoji or icon for the document",
                    ),
                ),
                (
                    "page",
