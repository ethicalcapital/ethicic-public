...
class BasePublicSiteTestCase(TestCase):
    ...
    def assert_form_errors(self, response, field: str, expected_error: Optional[str] = None):
...
class FormTestMixin:
    ...
    def assert_form_invalid(self, form, expected_errors: Optional[Dict[str, str]] = None):
