...
class BlogIndexPageTest(WagtailPublicSiteTestCase):
    ...
    def test_get_featured_posts(self):
        ...
        featured1 = self.create_test_blog_post(self.blog_index, "Featured 1", featured=True)
        featured2 = self.create_test_blog_post(self.blog_index, "Featured 2", featured=True)
...
class FAQArticleTest(WagtailPublicSiteTestCase):
    ...
    def test_faq_article_related(self):
        ...
        article2 = self.create_test_faq_article(
            parent=faq_index,
            title="Article 2"
        )
