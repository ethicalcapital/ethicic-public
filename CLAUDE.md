...
- **CRITICAL**: See `docs/CSS_MAINTENANCE_GUIDE.md` for comprehensive CSS management system
...
- **⚠️ UPDATE docs/CSS_MAINTENANCE_GUIDE.md** when making architectural CSS changes
