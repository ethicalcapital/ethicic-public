...
def ensure_index_pages():
    ...
    if not faq_index:
        ...
        if existing_faq and not isinstance(existing_faq, FAQIndexPage):
            print(f"Converting existing FAQ page (id: {existing_faq.id}) to FAQIndexPage...")
            # Convert the existing page to FAQIndexPage
            faq_index = FAQIndexPage.objects.create(
                page_ptr_id=existing_faq.id,
    ...
    if not encyclopedia_index:
        ...
        if existing_encyclopedia and not isinstance(existing_encyclopedia, EncyclopediaIndexPage):
            print(f"Converting existing Encyclopedia page (id: {existing_encyclopedia.id}) to EncyclopediaIndexPage...")
            # Convert the existing page to EncyclopediaIndexPage
            encyclopedia_index = EncyclopediaIndexPage.objects.create(
                page_ptr_id=existing_encyclopedia.id,
